...
export function ScrollCards({ items }: Props) {
  ...
  return (
    <div className="relative overflow-hidden">
      ...
      {isMobile ? (
        <div className="mt-10">
          {items.slice(index, index + 1).map((item) => (
            <div
              key={item.title}
              className="mx-auto w-full max-w-[420px] rounded-2xl border border-surface-border bg-gradient-to-br from-white to-surface-light p-5 shadow-soft"
            >
