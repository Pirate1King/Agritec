  ...
  return (
    ...
    >
      <div className="relative h-56 overflow-hidden">
        <img src={solution.hero_url || "/placeholder.jpg"} alt={solution.title} className="h-full w-full object-cover" />
        <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent" />
      </div>
      <div className="flex flex-1 flex-col gap-4 p-6">
        <Badge variant="outline">Giải pháp</Badge>
        <div>
          <h3 className="font-heading text-2xl text-brand-blue">{solution.title}</h3>
